...
var _require = require('typeorm'),
  ...
  PrimaryColumn = _require.PrimaryColumn,
  Column = _require.Column,
  ManyToOne = _require.ManyToOne,
  JoinColumn = _require.JoinColumn,
  BeforeInsert = _require.BeforeInsert;
var _require2 = require('../utils/security.util'),
  generateUniqueStationId = _require2.generateUniqueStationId;
var Station = (_dec = Entity(), _dec2 = PrimaryColumn({
  type: 'varchar',
  length: 255
}), _dec3 = Column({
  type: 'varchar',
  ...
  type: 'varchar',
  length: 255
}), _dec5 = ManyToOne(function () {
  return require('./user.model').User;
}, function (user) {
  return user.stations;
}), _dec6 = JoinColumn({
  name: 'user_id'
}), _dec7 = BeforeInsert(), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Station() {
    _classCallCheck(this, Station);
    _initializerDefineProperty(this, "id", _descriptor, this);
    _initializerDefineProperty(this, "station_name", _descriptor2, this);
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "station_name", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2.prototype, "generateUniqueId", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "generateUniqueId"), _class2.prototype), _class2)) || _class);
module.exports = {
  Station: Station
};