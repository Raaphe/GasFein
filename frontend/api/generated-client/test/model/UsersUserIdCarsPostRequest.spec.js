...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GasFeinApi.UsersUserIdCarsPostRequest();
  });
  ...
  describe('UsersUserIdCarsPostRequest', function() {
    it('should create an instance of UsersUserIdCarsPostRequest', function() {
      // uncomment below and update the code to test UsersUserIdCarsPostRequest
      //var instance = new GasFeinApi.UsersUserIdCarsPostRequest();
      //expect(instance).to.be.a(GasFeinApi.UsersUserIdCarsPostRequest);
    });
