...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GasFeinApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    describe('usersLoginJwtPost', function() {
      it('should call usersLoginJwtPost successfully', function(done) {
        //uncomment below and update the code to test usersLoginJwtPost
        //instance.usersLoginJwtPost(function(error) {
